...
export const TRANSACTION_ATTRIBUTES: SchemaAttribute[] = [
  { key: 'type', label: 'Type', type: 'enum', enumValues: ['buy', 'sell', 'sell_short', 'buy_to_cover', 'dividend', 'deposit', 'withdrawal', 'fee', 'interest', 'option_exercise', 'option_assign', 'option_expire'] },
