...
export const TEXT_INPUT_COLOR_EXAMPLE: SubviewSpec = {
  ...
  layout: [
    ...
    [
      ...
      { flex: { justifyContent: 'center', alignItems: 'center' }, padding: 6, showBorder: true, backgroundColor: 'mint', textColor: 'rgb(0,0,0)', content: [{ text: { value: 'mint', size: 'sm', alignment: 'center' } }] },
