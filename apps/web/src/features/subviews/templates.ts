...
export const SUBVIEW_TEMPLATES: SubviewTemplate[] = [
  { id: 'win-rate', name: 'Win Rate', description: '% of profitable trades', defaultSize: { w: 400, h: 70 }, categories: ['option'], spec: WIN_RATE_EXAMPLE as unknown as SubviewSpec },
  ...
  { id: 'secured-puts-capital', name: 'Secured Puts Capital', description: 'Total money occupied by secured puts (strike × 100 × contracts)', defaultSize: { w: 220, h: 50 }, categories: ['option'], spec: SECURED_PUTS_CAPITAL as unknown as SubviewSpec },
  ...
  { id: 'portfolio-pie', name: 'Allocation', description: 'Donut chart showing % of portfolio by holding', defaultSize: { w: 400, h: 220 }, categories: ['stock-etf'], spec: PORTFOLIO_PIE_CHART as unknown as SubviewSpec },
  ...
  { id: 'portfolio-value', name: 'Holdings Value', description: 'Total market value of current stock and ETF holdings', defaultSize: { w: 200, h: 50 }, categories: ['stock-etf'], spec: PORTFOLIO_VALUE as unknown as SubviewSpec },
  { id: 'unrealized-gain', name: 'Unrealized Gain', description: 'Unrealized gain: current holdings value minus book value', defaultSize: { w: 200, h: 70 }, categories: ['stock-etf'], spec: UNREALIZED_GAIN as unknown as SubviewSpec },
