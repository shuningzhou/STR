...
export const SUBVIEW_TEMPLATES: SubviewTemplate[] = [
  ...
  { id: 'portfolio-pie', name: 'Allocation', description: 'Donut chart showing % of portfolio by holding', defaultSize: { w: 400, h: 220 }, categories: ['essential', 'stock-etf'], spec: PORTFOLIO_PIE_CHART as unknown as SubviewSpec },
